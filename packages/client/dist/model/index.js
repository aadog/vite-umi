...
export function Provider(props) {
    return (React.createElement(Context.Provider, { value: { dispatcher } },
        Object.keys(props.models).map((namespace) => {
            return (React.createElement(Executor, { key: namespace, hook: props.models[namespace], namespace: namespace, onUpdate: (val) => {
